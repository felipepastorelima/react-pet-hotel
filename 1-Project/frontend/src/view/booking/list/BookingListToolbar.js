    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=booking">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: bookingSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: bookingSelectors.selectPermissionToImport(
      state,
    ),
  };
}
